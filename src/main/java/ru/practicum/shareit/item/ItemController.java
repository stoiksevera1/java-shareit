...
public class ItemController {
    ...
    @GetMapping
    public List<ItemDtoList> getAllItemsUser(@RequestHeader(value = "X-Sharer-User-Id", required = true) Long userId) {
        return itemService.getAllItemsUser(userId);
    }

    @GetMapping("/{itemId}")
    public ItemDto getItem(@RequestHeader(value = "X-Sharer-User-Id", required = true) Long userId,
    ...
    @GetMapping("/search")
    public List<ItemDtoList> searchItem(@RequestHeader(value = "X-Sharer-User-Id", required = true) Long userId,
